...
public class participant1 {
    ...
    public participant1(int id, boolean confirmation, String nom, String prenom, String date_inscrit) {
        this.id = id;
    ...
    public participant1(int id, boolean confirmation, String nom, String prenom, String date_inscrit, int evenement) {
        this.id = id;
        this.confirmation = confirmation;
        this.nom = nom;
        this.prenom = prenom;
